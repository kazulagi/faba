...
echo " >> IOClass.o"
echo " | =>      | (10%)\r\c "
mpif90 -cpp -Ofast -fopenmp -fopenacc -shared -fPIC -g -fcheck=all -fintrinsic-modules-path inc/  -c ./src/IOClass/IOClass.f90 -o  ./inc/IOClass.o
...
echo " >> RangeClass.o "
echo " | =>      | (20%)\r\c"
mpif90 -Ofast -fopenmp -fopenacc -shared -fPIC -g -fcheck=all -fintrinsic-modules-path inc/  -c ./src/RangeClass/RangeClass.f90 -o  ./inc/RangeClass.o
